...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "6433859194:AAG278JNU_qUmICZX_6BsDk2xXZlzeXkljA")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "movnews7bot") # Bot username without @.
    ...
    TECH_VJ_DATABASE_URL = os.environ.get("TECH_VJ_DATABASE_URL", "mongodb+srv://pabankumarmohanta64:nZOLzY2VyGkzl4Yq@paban.e8diitm.mongodb.net/?retryWrites=true&w=majority&appName=Paban")
    TECH_VJ_MAX_RESULTS = "50"

    # channel information
    TECH_VJ_LOG_CHANNEL = int(os.environ.get("TECH_VJ_LOG_CHANNEL", "-1002200892922")) # your log channel id and make bot admin in log channel with full right 
